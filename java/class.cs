...
<?cs include:"head_tag.cs" ?>
  <body>
    ...
    <!-- =========== FIELD SUMMARY =========== -->
    <section id="lattrs"><h3>XML Attribute Summary</h3>
    ...
    <!-- =========== FIELD SUMMARY =========== -->
    <section id="inhattrs">
      <h3>Inherited XML Attribute Summary</h3>
    <?cs each:cl=class.inherited ?>
      <?cs if:subcount(cl.attrs) ?>
    ...
    <?cs # this next line must be exactly like this to be parsed by eclipse ?>
    <!-- =========== ENUM CONSTANT SUMMARY =========== -->
    <section id="constants"><h3>Constant Summary</h3>
    ...
    <section id="inhconstants">
      <h3>Inherited Constant Summary</h3>
      <?cs each:cl=class.inherited ?>
        <?cs if:subcount(cl.constants) ?>
          <div class="expandable">
            <span class="showalways">
    ...
    <?cs # this next line must be exactly like this to be parsed by eclipse ?>
    <!-- =========== FIELD SUMMARY =========== -->
    <section id="lfields"><h3>Field Summary</h3>
      <table class="jd-sumtable">
    ...
    <!-- ======== CONSTRUCTOR SUMMARY ======== -->
    <section>
      <h3>Public Constructor Summary</h3>
    ...
    <!-- ======== CONSTRUCTOR SUMMARY ======== -->
    <section>
      <h3>Protected Constructor Summary</h3>
    ...
    <!-- ========== METHOD SUMMARY =========== -->
    <section>
      <h3>Protected Method Summary</h3>
